...
export default function EditAjudante() {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await axios.put(`http://localhost:8080/ajudante/${id_ajudante}`, ajudante);
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                    <h2 className="text-center m-4">Formulário Editar Ajudantes</h2>
